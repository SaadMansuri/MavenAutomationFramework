...
public class MyReporterListener implements IReporter
{
    ...
    public void generateReport(List<XmlSuite> xml, List<ISuite> suites,
        ...
        m_out.close();
        try {
			SendMailClass.execute("Current report");
		} catch (Exception e) {
			e.printStackTrace();
		}
    }
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
		...
		return new PrintWriter(new BufferedWriter(new FileWriter(new File(outdir, "email-repo-custo.html"))));
    }
    ...
    public void generateSuiteSummaryReport(List<ISuite> suites) {
        ...
        for (ISuite suite : suites) {
            ...
            for (ISuiteResult r : tests.values()) {
                ...
                // NEW
                //summaryCell(DateFunctions.dateToDayAndTime(overview.getStartDate()),true);
                m_out.println("</td>");
                //summaryCell(DateFunctions.dateToDayAndTime(overview.getEndDate()),true);
                m_out.println("</td>");
    ...
    protected void startHtml(PrintWriter out) {
        ...
        out.println("<head>");
        out.println("<title>Ashish Patil - TestNG Report</title>");
    ...
    protected void endHtml(PrintWriter out) {
        out.println("<center> Report customized by Ashish Patil [ashish.patil@cuelogic.co.in] </center>");
