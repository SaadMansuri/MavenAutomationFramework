...
public class MediaForm extends Page 
{

    private WebElement element;

	public MediaForm(WebDriver driver) 
    {
        super(driver);
    }
    ...
    public AvailabilityAndDetailsForm clickOnBackButtonOnMediaPage() throws Exception
    {
        AvailabilityAndDetailsForm details = null;
        try 
        {
            btn_BackOnMediaForm().click();
            details = new AvailabilityAndDetailsForm(driver); 
    ...
    public ContactsForm clickOnSaveAndContinueButton() throws Exception
    {
        ContactsForm contacts;
        try
        {
            btn_SaveAndContinue().click();
            contacts = new ContactsForm(driver);
    ...
    public WebElement txt_EmailAddress() throws Exception
    {
        try 
        {
    ...
    public WebElement txt_EmailAddressOnBanner() throws Exception
    {
        WebElement parent;
        try 
        {
            parent = driver.findElement(By.className("contact-details"));
            element = parent.findElements(By.tagName("p")).get(2);
            AutomationLog.info("Email id on banner is found");
        }
        catch (Exception e) 
        {
            AutomationLog.error("failed to find email id on banner");
            throw (e);
        }
        return element;
    }
