...
public class LoginNegativeTestsPageFormAction extends AutomationTestCase
{
    ...
    {
        Assert.assertEquals(loginPage.currentURL(), loginPage.getPageUrl(), "Login Page is not seen after failed login attempt");
