...
public class SearchProfessionalsAction extends AutomationTestCaseVerification 
{
    ...
    {
        searchprofessional.txtbx_agentSearch_element().clear();
    ...
    public void userSwitchBackFromSearchingExpertiseToAgentAndCompanySearch(SearchProfessionalsPage searchprofessional, HashMap<String, String> agentName) throws Exception
    {
        ...
        Assert.assertEquals(searchprofessional.dropBox_NeighborhoodsSearch_element().getText(),"" ,"Excepted result is the neighborhoods Search DropBox must get empty");
        AutomationLog.info("neighborhoods Search DropBox all text gets removed successfully");
        Assert.assertEquals(searchprofessional.checkbox_OfOfficeLeasingInExpertise_element().isSelected(),false ,"Excepted result is false and checkbox must not be clicked");
        AutomationLog.info("successfully verified that checkbox Of Office Leasing In Expertise is uncheck");
        Assert.assertEquals(searchprofessional.checkbox_OfRetailLeasingInExpertise_element().isSelected(),false ,"Excepted result is false and checkbox must not be clicked");
        AutomationLog.info("successfully verified that checkbox Of Retail Leasing In Expertise is uncheck");
        Assert.assertEquals(searchprofessional.checkbox_OfTenantRepresentationInConcentration_element().isSelected(),false ,"Excepted result is false and checkbox must not be clicked");
        AutomationLog.info("successfully verified that checkbox Of Tenant Representation In Concentration is uncheck");
        Assert.assertEquals(searchprofessional.checkbox_OfLandlordRepresentationInConcentration_element().isSelected(),false ,"Excepted result is false and checkbox must not be clicked");
